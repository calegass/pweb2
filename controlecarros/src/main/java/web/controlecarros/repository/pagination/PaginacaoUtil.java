package web.controlecarros.repository.pagination;
...
public class PaginacaoUtil {
	...
	// criada dentro do mét_odo.
	//Não encontrei uma maneira de deixar isso genérico, tem que repetir em t_odo lugar
	// que usar paginação
