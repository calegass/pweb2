package web.controlecarros.config;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
				.authorizeHttpRequests(configurer -> configurer
						...
						// para essas
						// URLs
						.requestMatchers("/carros/novo").hasRole("ADMIN")
						.requestMatchers("/usuarios/cadastrar").hasRole("ADMIN")
						.requestMatchers("/alugueis/alugar").hasRole("ADMIN")
						.requestMatchers("/alugueis/devolver").hasRole("ADMIN")
						.requestMatchers("/alugueis/historico").hasRole("ADMIN")
